...
This is the exact text sent as `systemInstruction` to Gemini on every request.
The live copy lives in `lib/prompt.js` — edit there, or edit here and paste it back.
